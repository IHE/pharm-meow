# Medication Treatment Line (model) - IHE Pharmacy Medication Overview v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/MedicationTreatmentLineLM | *Version*:0.1.0 |
| Active as of 2026-05-14 | *Computable Name*:MedicationTreatmentLineLM |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ihe.pharm.meow|current/StructureDefinition/MedicationTreatmentLineLM)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      {
        "code" : "Reference",
        "targetProfile" : ["http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/MedicinalProductLM"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/MedicationTreatmentLM"]
      }]
    },
    {
