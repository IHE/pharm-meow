...
* doseAndRate 0..* BackboneElement "Amount of medication administered per one dose (= one timing)"
  ...
  * dose 0..1 Quantity "!Range or SimpleQuantity. Amount of medication per one dose. (1 tablet, 2-3 tablets, 20ml)"
  * rate 0..1 Ratio "!Ratio, Range or SimpleQuantity. Time period during which one defined dose is administered (per 1 hour, per 5-10 minutes)"
