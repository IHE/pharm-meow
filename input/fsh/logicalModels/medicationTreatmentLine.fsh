...
* intendedUse 0..1 CodeableConcept "Intended Use of the medication - prophylaxis, therapy..."
...
* substitution 0..1 BackboneElement "Whether and which type of substitution is allowed for this medication treatment line" 
  * substitutionType 1..1 CodeableConcept "The type of substitution that is allowed."
  * substitutionTypeReason 0..1 CodeableConcept "Coded reason for the substitution requirement"
