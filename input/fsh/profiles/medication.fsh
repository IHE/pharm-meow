...
* extension contains MedicinalProductName named productName 0..*
* extension[productName] ^short = "Name of the medicinal product. Names of different types (full name, short name, etc) and in different languages can be provided if relevant." // productName

* extension contains Classification named classification 0..*
* extension[classification] ^short = "Classifications of the product, e.g ATC, narcotic/psychotropic, orphan drug, etc"

* extension contains SizeOfMedicationItem named sizeOfItem 0..1
...
* ingredient MS
  ...
  * item only CodeableReference(Substance or MedicinalProduct)
  * strength[x] MS
