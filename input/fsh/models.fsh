...
* doseForm 0..* Class "The intended or existing dose form for the product"
...
* item 1..* Class "Manufactured item if the prescription contains more than one type of items"
