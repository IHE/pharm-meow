# Medicinal product - IHE Pharmacy Medication Overview v0.1.0
...
| Active as of 2026-05-14 | *Computable Name*:IHEMedication |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ihe.pharm.meow|current/StructureDefinition/IHEMedication)
...
```json
{
  ...
  "id" : "IHEMedication",
  "url" : "http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/IHEMedication",
  "version" : "0.1.0",
  "name" : "IHEMedication",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/ihe-ext-medication-productname"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/ihe-ext-medication-classification"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/ihe-ext-medication-sizeofitem"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/ihe-ext-medication-device"]
      }]
    },
    {
