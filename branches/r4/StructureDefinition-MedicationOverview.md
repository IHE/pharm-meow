# Medication Overview Bundle - IHE Pharmacy Medication Overview v1.0.0-preview2
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/PHARM/MEOW/StructureDefinition/MedicationOverview | *Version*:1.0.0-preview2 |
| Active as of 2026-07-07 | *Computable Name*:MedicationOverviewBundle |
  ...
  "differential" : {
    ...
    },
    {
      ...
      "slicing" : {
        ...
        "description" : "Slicing based on the resource type of the sliced element",
        "rules" : "open"
      },
      "min" : 2
    },
