# Medication Treatment Line (model) - IHE Pharmacy Medication Overview v1.0.0-preview2
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/PHARM/MEOW/StructureDefinition/MedicationTreatmentLineLM | *Version*:1.0.0-preview2 |
| Active as of 2026-07-07 | *Computable Name*:MedicationTreatmentLineLM |
...
```json
{
  ...
  "status" : "active",
  "date" : "2026-07-07T15:14:46+00:00",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://profiles.ihe.net/PHARM/MEOW/StructureDefinition/PatientLM"]
      }]
    },
    {
    ...
    },
    {
      ...
      "short" : "Person entering the statement by initiating a treatment or documenting a statement by a patient or another professional. The recorder may be different from the author. Optional because minimal sources (e.g. PH4H MedicationOverviewMin) do not carry a recorder.",
      "definition" : "Person entering the statement by initiating a treatment or documenting a statement by a patient or another professional. The recorder may be different from the author. Optional because minimal sources (e.g. PH4H MedicationOverviewMin) do not carry a recorder.",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Reference"
