...
| Active as of 2026-06-25 | *Computable Name*:MedicationOverviewLM |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "max" : "1",
      "type" : [{
        "code" : "http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/PatientLM"
      }]
    },
    {
      ...
      "max" : "*",
      "type" : [{
        "code" : "http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/MedicationTreatmentLineLM"
      }]
    },
    {
