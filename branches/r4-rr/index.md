...
| Active as of 2026-06-25 | *Computable Name*:IHE_PHARM_MEOW |
...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "http://profiles.ihe.net/PHARM/MEOW/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "exampleCanonical" : "http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/IHEMedication"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
