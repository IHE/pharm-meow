# Medication Overview Responder - IHE Pharmacy Medication Overview v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://profiles.ihe.net/PHARM/MEOW/CapabilityStatement/MedicationOverviewResponder | *Version*:0.1.0 |
...
```json
{
  ...
  "url" : "http://profiles.ihe.net/PHARM/MEOW/CapabilityStatement/MedicationOverviewResponder",
  "version" : "0.1.0",
  ...
  "rest" : [{
    ...
    },
    {
      ...
      "documentation" : "Optionally returned as _include of MedicationStatement:basedOn (prescriptions).",
      "interaction" : [{
        "code" : "read"
      }]
    },
