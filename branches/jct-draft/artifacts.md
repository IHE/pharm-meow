# Artifacts Summary - IHE Pharmacy Medication Overview v0.1.0
...
| [MedicationStatement - Clinical Intent Type](StructureDefinition-ihe-ext-medicationstatement-clinicalintenttype.md) | The clinical intent type of the medication use - whether the medication is for therapeutic, prophylactic, or self-medication purposes. |
| [MedicationStatement - Off-Label Use](StructureDefinition-ihe-ext-medicationstatement-offlabel.md) | Indication that the medication is being used off-label (outside of approved indication, age group, dosage, or route) and the reason for such use. When isOffLabelUse is true, a reason SHALL be provided. |
| [MedicationStatement - Recorder](StructureDefinition-ihe-ext-medicationstatement-recorder.md) | The person who entered the medication information into the system. The recorder may be different from the clinical author (informationSource) who made the clinical decision. |
...
| | |
| :--- | :--- |
| [Clinical Intent Type ValueSet](ValueSet-ihe-vs-clinicalintenttype.md) | The clinical intent type of the medication use - therapeutic, prophylactic, or self-medication. |
...
| | |
| :--- | :--- |
| [Clinical Intent Type CodeSystem](CodeSystem-ihe-cs-clinicalintenttype.md) | Codes for the clinical intent type of medication use. |
