# Medication Overview Bundle - IHE Pharmacy Medication Overview v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/MedicationOverview | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*:MedicationOverviewBundle |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ihe.pharm.meow|current/StructureDefinition/MedicationOverview)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Composition",
        "profile" : ["http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/MedicationOverviewComposition"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "CarePlan",
        "profile" : ["http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/MedicationTreatment"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "profile" : ["http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/MedicationTreatmentLine"]
      }],
      "mustSupport" : true
    },
    {
