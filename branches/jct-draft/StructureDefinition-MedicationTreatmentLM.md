# Medication Treatment (model) - IHE Pharmacy Medication Overview v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/MedicationTreatmentLM | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*:MedicationTreatmentLM |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ihe.pharm.meow|current/StructureDefinition/MedicationTreatmentLM)
...
```json
{
  ...
  "url" : "http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/MedicationTreatmentLM",
  "version" : "0.1.0",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "http://profiles.ihe.net/PHARM/MEOW/StructureDefinition/MedicationTreatmentLM",
