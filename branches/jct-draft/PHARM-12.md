# PHARM-12 Query Medication Resources - IHE Pharmacy Medication Overview v0.1.0
...
For pre-assembled overviews, see [PHARM-11](PHARM-11.md).
...
| | | |
| :--- | :--- | :--- |
| **Treatment line** | Clinician-determined treatment item; the central entity of the medication overview. May link to prescriptions, dispenses, administrations. | [MedicationTreatmentLine](StructureDefinition-MedicationTreatmentLine.md) |
...
| `_include=MedicationStatement:basedOn` | forward | `MedicationRequest`(prescriptions) |
...
* `MedicationTreatmentLine` resources SHALL conform to [MedicationTreatmentLine](StructureDefinition-MedicationTreatmentLine.md).
* Included `CarePlan` resources SHALL conform to [MedicationTreatment](StructureDefinition-MedicationTreatment.md).
* Included `Medication` resources SHALL conform to [IHEMedication](StructureDefinition-IHEMedication.md).
